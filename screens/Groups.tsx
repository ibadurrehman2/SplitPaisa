...
import { Users, ChevronRight, Plane, Briefcase, Home, Plus, Settings } from 'lucide-react';
import CreateGroup from './CreateGroup';

export default function Groups() {
  const { groups, users, expenses, settlements, currentUser } = useApp();
    ...
    <div className="p-5 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="flex items-center space-x-1 bg-indigo-50 text-indigo-600 px-3 py-1.5 rounded-full text-sm font-bold active:scale-95 transition-transform"
        >
