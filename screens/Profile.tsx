...
import { Settings, LogOut, ChevronRight, Share2, Shield, CircleHelp, Smartphone, Camera } from 'lucide-react';
    ...
    <div className="p-5 space-y-8">
      ...
      <div className="flex flex-col items-center pt-8 space-y-4">
        <div className="relative group cursor-pointer" onClick={handleAvatarClick}>
          <img src={currentUser?.avatar} className="w-28 h-28 rounded-[40px] shadow-2xl border-4 border-white object-cover" />
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 font-medium tracking-tight">+91 {currentUser?.phone}</p>
        </div>
      </div>
